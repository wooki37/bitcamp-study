...
- 프로젝트 실습
  - 8. 스태틱 메서드 간에 변수 공유하기: 스태틱 변수 사용법(계속)
    - 리팩토링 : 메드 추가 정의, 상수 선언
  - 9. 메서드를 역할데 따라 분류하기 : 클래스 및 패키지 사용법
- 과제(개인)
  - 개인 프로젝트 수행
    - 프로젝트 폴더 생성 및 초기화
...
- 프로젝트 실습
  ...
  - 프로젝트 실습
    - p.GRASP패턴: Information Expert 적용
    - q.인터페이스를 이용한 객체 사용 규칙 정의
    - r.인스턴스 목록 제어 기능을 별도의 클래스로 캡슐화: 재사용성 높임
  ...
  - 프로젝트 실습
    - s.다형성을 이용하여 범용으로 사용할 수 있는 목록 클래스 만들기

  ### 19일(6/19,월)

  - 프로젝트 실습
    - LinkedList 자료구조 구현하기
    - 인터페이스를 이용한 List 사용 규칙 정의하기
